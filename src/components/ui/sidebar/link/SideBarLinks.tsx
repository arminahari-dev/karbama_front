...
const SideBarLinks: React.FC = () => {
  ...
  return (
    <div className="flex flex-row tablet:flex-col max-tablet:justify-between items-center max-tablet:items-center tablet:gap-8 tablet:!p-8 max-tablet:!px-8 h-full whitespace-nowrap">
